...
class LocalFileListCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        let mainWidth = App.Size.screenWidth / 10 * 6
        lblMain.topAnchor.constraint(equalTo: topAnchor, constant: 15).isActive = true
        ...
        lblSub.topAnchor.constraint(equalTo: topAnchor, constant: 30).isActive = true
        ...
        lblDevice.topAnchor.constraint(lessThanOrEqualTo: topAnchor, constant: 30).isActive = true
        lblDevice.leadingAnchor.constraint(equalTo: trailingAnchor, constant: -width).isActive = true
        lblDevice.widthAnchor.constraint(equalToConstant: width-30).isActive = true
        lblDevice.heightAnchor.constraint(equalToConstant: 15).isActive = true
